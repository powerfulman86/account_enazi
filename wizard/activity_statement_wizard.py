...
class ActivityStatementWizard(models.TransientModel):
    ...
    def _get_date_start(self):
        return (fields.Date.context_today(self).replace(day=1) - relativedelta(days=1)).replace(day=1)
    ...
    def _export(self):
        ...
        return self.env.ref("account_enazi.action_print_activity_statement").report_action(self.ids, data=data)
